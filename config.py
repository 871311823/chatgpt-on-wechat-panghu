...
available_setting = {
    ...
    "web_port": 9899,
    # 数据库配置
    "db_url": "",  # 例如: mysql+pymysql://user:pass@host:3306/dbname?charset=utf8mb4
    # 天气推送配置
    "weather": {},  # 天气推送配置，包含amap_key, target_user, city_adcode等
    # NOFX交易系统配置
    "nofx": {},  # NOFX配置，包含email, password, base_url等
}
